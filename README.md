...
A separate Colab notebook can run NLRexpress and prepare optional `name,sequence,aa_change` batch input files for CodonDomesticate, keeping MHD candidate metadata and warning when MHD probability is below a configurable threshold.
